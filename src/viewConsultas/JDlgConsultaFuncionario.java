...
private FuncionarioControle funcionarioControle;
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jTxtSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarMslActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarMslActionPerformed
        if (jTxtNomeMsl.getText().isEmpty() && jTxtSalario.getText().isEmpty()) {
            List lista = funcionarioDAO.listNome(jTxtNomeMsl.getText());
            funcionarioControle.setList(lista);
        } else {
            if (!jTxtNomeMsl.getText().isEmpty() && !jTxtSalario.getText().isEmpty()) {
                double salario = Double.parseDouble(jTxtSalario.getText());  
                List lista = funcionarioDAO.listNomeSalario(jTxtNomeMsl.getText(), salario);
                funcionarioControle.setList(lista);
            } else {
                ...
                if (!jTxtSalario.getText().isEmpty()) {
                    double salario = Double.parseDouble(jTxtSalario.getText());  
