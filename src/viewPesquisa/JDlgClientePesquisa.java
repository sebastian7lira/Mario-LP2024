...
public class JDlgClientePesquisa extends javax.swing.JDialog {
    ...
    private ClienteControle clienteControle;//invoca o clientes controle para controla-lo
    /**
    ...
    public JDlgClientePesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        clienteControle = new ClienteControle();//invoca o clientes controle para controla-lo
        ClienteDAO clienteDAO = new ClienteDAO();
        List lista = clienteDAO.listAll();
        clienteControle.setList(lista);
        jTable1Msl.setModel(clienteControle);
    ...
    private void jBtnOKMslActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOKMslActionPerformed
        ...
        ClienteMsl cliente = clienteControle.getBean(rowSel);
        jDlgCliente.beanView(cliente);
        jDlgCliente.pesquisado = true;
        setVisible(false);
