...
public class JDlgUsuariosPesquisa extends javax.swing.JDialog {
    ...
    private UsuariosControle usuariosControle;//invoca o clientes controle para controla-lo
    /**
    ...
    public JDlgUsuariosPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        usuariosControle = new UsuariosControle();//invoca o clientes controle para controla-lo
        UsuariosDAO usuariosDAO = new UsuariosDAO();
        List lista = usuariosDAO.listAll();
        usuariosControle.setList(lista);
        jTable1Msl.setModel(usuariosControle);
    ...
    private void jBtnOKMslActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOKMslActionPerformed
        ...
        UsuariosMsl usuarios = usuariosControle.getBean(rowSel);
        jDlgUsuarios.beanView(usuarios);
        jDlgUsuarios.pesquisado = true;
        setVisible(false);
